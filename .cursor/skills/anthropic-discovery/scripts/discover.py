...
def normalize_list_item(item: dict) -> dict:
    ...
    slug = href.removeprefix("/news/") if href.startswith("/news/") else href.rsplit("/", 1)[-1]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="发现 Anthropic News 文章")
