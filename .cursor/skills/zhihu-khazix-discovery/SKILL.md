---
name: zhihu-khazix-discovery
description: >-
  Discovers articles from 知乎用户 数字生命卡兹克 (Khazix).
  Requires ZHIHU_COOKIE for server-side access.
---

# 知乎 · 数字生命卡兹克

主页：https://www.zhihu.com/people/Khazix/posts
...
```bash
export ZHIHU_COOKIE='...'
python .cursor/skills/zhihu-khazix-discovery/scripts/discover.py --page 1 --per 20
```

## 接入 Askme

Feed ID：`website:zhihu:khazix`
