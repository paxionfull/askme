...
```bash
# 最近 1 天文章（默认）
python .cursor/skills/jiqizhixin-discovery/scripts/discover.py

# 最近 3 天
python .cursor/skills/jiqizhixin-discovery/scripts/discover.py --days 3

# 仅第 1 页（20 篇）
python .cursor/skills/jiqizhixin-discovery/scripts/discover.py --mode page --page 1 --per 20

# 单篇详情（含完整 HTML 正文）
python .cursor/skills/jiqizhixin-discovery/scripts/discover.py --slug 2026-07-02-9
```
...
后端 `FeedClient` 启动时会扫描 `.cursor/skills/*-discovery/scripts/discover.py`，加载实现了 **WebsiteFeedAdapter** 的模块。
