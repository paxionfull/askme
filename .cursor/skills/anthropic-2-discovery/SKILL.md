...
```bash
python .cursor/skills/anthropic-2-discovery/scripts/discover.py --page 1 --per 20
python .cursor/skills/anthropic-2-discovery/scripts/discover.py --id research/global-workspace
```
